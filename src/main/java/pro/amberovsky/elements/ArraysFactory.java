...
class ArraysFactory {
     ...
     */
    enum DELETE_DUPLICATES { BRUTEFORCE, FAST }
     ...
     */
    static UnaryOperator<Integer[]> getDeleteDuplicates(DELETE_DUPLICATES algorithm) {
        switch (algorithm) {
            case BRUTEFORCE:
     ...
     */
    enum BUY_AND_SELL_A_STOCK_TWICE { ONE_ITERATION, SPACE }
     ...
     */
    static Function<Integer[], Integer> getBuyAndSellAStockTwice(BUY_AND_SELL_A_STOCK_TWICE algorithm) {
        switch (algorithm) {
            case ONE_ITERATION:
     ...
     */
    enum PERMUTE_THE_ELEMENTS_OF_AN_ARRAY { ONE_ITERATION, SPACE }
     ...
     */
    static BinaryOperator<Integer[]> getPermuteTheElementsOfAnArray(PERMUTE_THE_ELEMENTS_OF_AN_ARRAY algorithm) {
        switch (algorithm) {
            case ONE_ITERATION:
